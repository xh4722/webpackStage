...
class HTTP {
  ...
  get(url, params, headers) {
    params = extendObject(true, {}, this.config.params, params || {})
    headers = extendObject(true, {}, this.config.headers, headers || {})
    ...
    if (params) {
      ...
      if (url.search(/\?/) === -1) {
        ...
        urlParams = queryString.stringify(
          extendObject(true, {}, params, queryString.parse(url.split('?')[1]))
        )
      }
